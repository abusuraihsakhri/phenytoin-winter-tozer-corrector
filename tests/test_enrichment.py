"""
Automated Pytest for phenytoin-winter-tozer-corrector Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    MultipleCorrectionEquationsEngine,
    FreePhenytoinPredictionEngine,
    PhenytoinDoseOptimizationMichaelismentenEngine,
    DrugInteractionFlagsEngine,
    LevelMonitoringScheduleEngine,
    ToxicityThresholdAlertingEngine,
    PhenytoinwintertozercorrectorEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = PhenytoinwintertozercorrectorEnrichmentSuite()
